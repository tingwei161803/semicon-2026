...
| 現場快報 | `news.html` | **展前到展會期間的現場整理**（5 月啟動記者會起，以 8/31–9/4 展會週為主）：官方新聞稿、媒體報導、廠商發表與社群貼文共 53 則，依日期倒序排列，可搜尋與依來源類型篩選；**每一則都連到原始出處**。頁首有重點資訊圖輪播（中文 3 張、英文 4 張）與六條「今年舉辦的重點」歸納 |
...
「現場快報」則另外整理自展會期間（2026/8/31–9/4）的公開報導與公開貼文，來源包含 SEMI 官方新聞稿、中央社 Focus Taiwan、Taipei Times、TrendForce、Digitimes Asia、科技新報 TechNews、中評社、mashdigi、廠商官方新聞稿，以及 LinkedIn / YouTube 上的公開貼文。

...
這是一個獨立、非官方的整理站，把 SEMICON Taiwan 2026 的總覽、論壇陣容、論壇時間軸、技術特區、活動週程、逛展參考與參觀須知，展會期間的現場快報，再加上四款半導體主題小遊戲，整理成 9 個彼此串連的頁面。內容整理自官方網站，純 HTML / CSS / JS、零 build，可直接部署到 GitHub Pages。
...
| 現場快報 | `news.html` | **展會期間（8/31–9/4）的現場整理**：官方新聞稿、媒體報導、廠商發表與社群貼文共 53 則，依日期倒序排列，可搜尋與依來源類型篩選；**每一則都連到原始出處**。頁首有重點資訊圖輪播（中英各一套）與六條「今年舉辦的重點」歸納 |
...
- 🖼️ **重點資訊圖輪播** — 中英各一套視覺整理，捲動吸附讓它沒有 JS 也能滑，圓點是真的錨點連結；箭頭、鍵盤左右鍵與自動輪播為漸進增強，讀者一動手就永久停止自動播放，並尊重 `prefers-reduced-motion`

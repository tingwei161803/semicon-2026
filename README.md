...
這是一個獨立、非官方的整理站，把 SEMICON Taiwan 2026 的總覽、論壇陣容、技術特區、活動週程與參觀須知，整理成 5 個彼此串連的頁面。內容整理自官方網站，純 HTML / CSS / JS、零 build，可直接部署到 GitHub Pages。
...
> 直接點進去就能用，無需安裝。頂部跨頁導覽列可在 5 頁之間切換；每頁皆支援中文 / English 與深 / 淺色，論壇頁可用 `…/forums.html#<slug>` 深連結到特定論壇。
...
- 參觀購票、展區平面圖、參展廠商名單、規劃行程

```
semicon-2026/
├── index.html / forums.html / zones.html / events.html / visit.html   # 5 個共用 shell 的頁面
├── assets/

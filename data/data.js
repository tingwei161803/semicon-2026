...
window.SITE_PAGES = [
   ...
   * ===================================================================== */
  {
    ...
    items: [
      ...
      { date: "2026-08-19", category: "official", lang: "en",
        source: { en: "SEMI (via PR Newswire)", zh: "SEMI 官方（PR Newswire）" },
        title: { en: "SEMICON Taiwan 2026 highlights AI-driven manufacturing transformation",
                 zh: "SEMI 公布 15 大議題：AI 驅動的製造轉型，智慧製造成最大展區" },
        summary: { en: "Two weeks before opening, SEMI set out 15 key themes for the show and said 300mm fab equipment spending is projected to exceed US$150 billion in 2027. The Smart Manufacturing Pavilion grew 20% year on year to become the largest exhibition area, with the Packaging Technology Area up 6% in second place; advanced packaging and assembly equipment sales hit a record US$6 billion in 2025 and are expected to grow 9.2% in 2026. SEMI's Terry Tsao framed AI-era competition as running on two fronts: AI-powered smart manufacturing and advanced packaging.",
                   zh: "開展前兩週，SEMI 公布本屆 15 大關鍵議題，並預估 2027 年全球 300mm 晶圓廠設備支出將首度突破 1,500 億美元。智慧製造專區年增 20% 成為最大展區，封裝技術專區成長 6% 居次；先進封裝與組裝設備 2025 年銷售額創 60 億美元新高、2026 年預期再成長 9.2%。SEMI 全球行銷長曹世綸把 AI 時代的競爭歸納為兩條戰線：AI 驅動的智慧製造，以及讓效能整合再升級的先進封裝。" },
        href: "https://www.prnewswire.com/apac/news-releases/semicon-taiwan-2026-highlights-ai-driven-manufacturing-transformation-302853886.html",
        tags: [ { en: "Smart manufacturing", zh: "智慧製造" }, { en: "Advanced packaging", zh: "先進封裝" }, { en: "Forecast", zh: "預測" } ] },

      { date: "2026-09-02", category: "official", lang: "en",
        source: { en: "ITRI (via GlobeNewswire)", zh: "工研院（GlobeNewswire）" },
        title: { en: "Semicon Network Summit 2026 advances global chip collaboration in the AI era",
                 zh: "Semicon Network Summit 2026：AI 時代的全球晶片合作" },
        summary: { en: "Co-organisers ITRI and SEMI said more than 600 government officials, industry leaders and researchers from 38 countries attended the 1 September summit in Taipei. President Lai Ching-te presented the Medal of Economic Contribution to Doris Hsu of Sino-American Silicon Products and GlobalWafers and to Micron CEO Sanjay Mehrotra. The summit set four priorities: advanced technologies and materials, cross-border collaboration in silicon photonics, chips for AI robotics, and semiconductor cybersecurity resilience.",
                   zh: "共同主辦的工研院與 SEMI 表示，9 月 1 日在台北舉行的峰會有來自 38 國、逾 600 位政府官員、產業領袖與研究專家與會。總統賴清德頒發經濟貢獻獎章給環球晶圓暨中美晶董事長徐秀蘭與美光執行長 Sanjay Mehrotra。峰會提出四大重點：先進技術與材料、矽光子跨國合作、AI 機器人晶片，以及半導體資安韌性。" },
        href: "https://www.globenewswire.com/news-release/2026/09/02/3354875/0/en/semicon-network-summit-2026-advances-global-chip-collaboration-in-the-ai-era.html",
        tags: [ { en: "Network Summit", zh: "Network Summit" }, { en: "Government", zh: "政府" } ] },
...
/* ---------------- media ---------------- */
      ...
      { date: "2026-09-02", category: "media", lang: "en",
        source: { en: "Taipei Times · Reuters", zh: "Taipei Times · 路透社" },
        title: { en: "Taiwanese companies plan to invest another US$20bn in US amid AI boom",
                 zh: "AI 熱潮下，台灣企業規劃再加碼 200 億美元投資美國" },
        summary: { en: "Reuters report carried by the Taipei Times: speaking at the opening of the US pavilion at SEMICON Taiwan, Economic Affairs Minister Kung Ming-hsin said Taiwanese firms plan an additional US$20 billion of US investment — mainly chip supply-chain and AI-server companies — on top of the US$35 billion pledged by 20 companies at May's SelectUSA summit. A US Commerce Department official said it \"demonstrates our continued shared commitment to a secure, resilient and innovative semiconductor and electronics supply chain\".",
                   zh: "路透社報導、Taipei Times 刊出：經濟部長龔明鑫在 SEMICON Taiwan 美國館開幕時表示，台灣企業規劃在 5 月 SelectUSA 峰會 20 家公司承諾的 350 億美元之外，再加碼 200 億美元投資美國，主要來自半導體供應鏈與 AI 伺服器相關業者。美國商務部官員回應，這「展現雙方對安全、韌性且創新的半導體與電子供應鏈的持續共同承諾」。" },
        href: "https://www.taipeitimes.com/News/biz/archives/2026/09/02/2003863570",
        tags: [ { en: "US investment", zh: "美國投資" }, { en: "Government", zh: "政府" } ] },

      { date: "2026-09-01", category: "media", lang: "en",
        source: { en: "TaiwanPlus", zh: "TaiwanPlus" },
        title: { en: "Explainer: What to know about Semicon Taiwan 2026",
                 zh: "解說：開展前你該知道的 SEMICON Taiwan 2026" },
        summary: { en: "A 3:25 video explainer published the evening before opening day: Taiwan makes over 90% of the world's most advanced chips and its industry revenue is expected to near US$300 billion in 2026, up about 40%. SEMI Taiwan president Terry Tsao says \"the face of the industry is being reshaped\"; TrendForce's Joanne Chiao points to chipmakers moving toward \"Foundry 2.0\", building out both upstream and downstream of the value chain.",
                   zh: "開展前夕發布的 3 分 25 秒影音解說：台灣生產全球逾九成最先進晶片，2026 年產業營收預估逼近 3,000 億美元、年增約四成。SEMI 全球行銷長暨台灣區總裁曹世綸說「產業的面貌正在被重塑」；TrendForce 分析師 Joanne Chiao 指出晶圓廠正走向「Foundry 2.0」，同時布局價值鏈的上下游。" },
        href: "https://www.taiwanplus.com/news/taiwan-news/technology-and-science/260901016/explainer-what-to-know-about-semicon-taiwan-2026",
        tags: [ { en: "Explainer", zh: "解說" }, { en: "Video", zh: "影音" } ] },

      { date: "2026-08-31", category: "media", lang: "zh",
        source: { en: "TechOrange", zh: "科技報橘 TechOrange" },
        title: { en: "Silicon Photonics Forum: CPO enters volume production in the second half — what is the next hurdle?",
                 zh: "SEMICON 矽光子論壇：CPO 下半年進入量產，下一關卡在哪裡？" },
        summary: { en: "Floor report from the Silicon Photonics Forum: TSMC's Hsu Kuo-chin said optical transceiver sales grew 25% and are expected to grow another 50% this year, with CPO entering volume production in the second half — the bottleneck shifting to lasers, fibre, connectors and test. TSMC's Chen Ming-fa outlined the move from CPO-C to a more tightly integrated CPO-OI, presented as 4–10× better power efficiency and 10–20× lower latency; Cisco, Marvell, Lumentum, UMC and Lightmatter also spoke.",
                   zh: "矽光子論壇現場整理：台積電先進封裝技術發展副總經理徐國晉指出，光收發模組銷售額已成長 25%、今年預期再成長 50%，CPO 將在今年下半年進入量產，但瓶頸移到雷射、光纖、連接器與測試。台積電陳明發介紹從 CPO-C 走向與 XPU 更緊密整合的 CPO-OI，簡報稱功耗效率可提升 4 至 10 倍、延遲降低 10 至 20 倍；Cisco、Marvell、Lumentum、聯電與 Lightmatter 也上台。" },
        href: "https://techorange.com/2026/08/31/semicon-2026-silicon-photonics-forum-cpo/",
        tags: [ { en: "Silicon photonics", zh: "矽光子" }, { en: "CPO", zh: "CPO" }, { en: "Forum", zh: "論壇" } ] },

      { date: "2026-09-02", category: "media", lang: "zh",
        source: { en: "DIGITIMES (Chinese)", zh: "電子時報 DIGITIMES" },
        title: { en: "CPO materials platform has not converged; Taiwan vies for a key seat through heterogeneous integration and advanced packaging",
                 zh: "CPO材料平台尚未收斂　台灣憑異質整合與先進封裝爭關鍵席位" },
        summary: { en: "From the silicon-photonics session of the show's Silicon Chain Summit — with Marvell, the Netherlands' TNO Holst Centre, a UK semiconductor centre and TSIA among the speakers — DIGITIMES argues the CPO materials platform has yet to converge, and that Taiwan's seat at the table rests on heterogeneous integration and advanced packaging. Full text is behind membership.",
                   zh: "SEMICON Taiwan 2026 晶鏈高峰論壇的矽光子場次，Marvell、荷蘭國家應用科學研究院霍斯特研發中心、英國半導體中心與台灣半導體產業協會等談矽光子發展；文章指 CPO 的材料平台尚未收斂，台灣要靠異質整合與先進封裝爭取關鍵位置。全文需會員登入。" },
        href: "https://www.digitimes.com.tw/tech/dt/n/shwnws.asp?id=0000766924_0M5LUI831QXZ2H52SB1I6",
        tags: [ { en: "Silicon photonics", zh: "矽光子" }, { en: "CPO", zh: "CPO" }, { en: "Forum", zh: "論壇" } ] },

      { date: "2026-09-04", category: "media", lang: "zh",
        source: { en: "StockFeel", zh: "股感 StockFeel" },
        title: { en: "What is SEMICON Taiwan 2026? This year's highlights and what each exhibitor showed",
                 zh: "SEMICON Taiwan 2026 半導體展是什麼？本屆亮點與各家廠商展出內容一次看！" },
        summary: { en: "A post-show overview published on closing day: what SEMICON Taiwan is, this year's threads — AI semiconductors, advanced packaging, quantum, smart manufacturing and compound semiconductors — and what TSMC, MediaTek and the equipment makers actually put on the floor, framed around the shift from process scaling to system integration.",
                   zh: "閉幕當天發布的展後總覽：從 SEMICON Taiwan 是什麼講起，整理今年 AI 半導體、先進封裝、量子、智慧製造與化合物半導體等主軸，以及台積電、聯發科與設備商在展場的展出內容，並點出產業重心正從製程微縮轉向系統整合。" },
        href: "https://www.stockfeel.com.tw/semicon-taiwan-%E5%9C%8B%E9%9A%9B%E5%8D%8A%E5%B0%8E%E9%AB%94%E5%B1%95/",
        tags: [ { en: "Recap", zh: "展後整理" } ] },

      { date: "2026-08-24", category: "media", lang: "zh",
        source: { en: "TVBS News", zh: "TVBS 新聞網" },
        title: { en: "SEMICON Taiwan 2026 cheat sheet: a record 18 national pavilions, and six trends from silicon photonics to advanced packaging",
                 zh: "SEMICON Taiwan 2026懶人包》18國參展規模創紀錄！矽光子與先進封裝6大趨勢一次看" },
        summary: { en: "Pre-show explainer: 1,300 exhibitors, 4,300 booths, 65 countries, 100,000+ professionals and 18 national pavilions, organised around six directions — AI chips, advanced packaging, chiplets, quantum, silicon photonics and green manufacturing — and citing SEMI's forecast of US$165.9 billion in 2026 global equipment sales, up 23.2%.",
                   zh: "展前懶人包：1,300 家展商、4,300 個攤位、65 國、逾 10 萬名專業人士、18 國設國家館，整理 AI 半導體、先進封裝、Chiplet、量子、矽光子與綠色製造六大方向；並引述 SEMI 預估 2026 年全球半導體設備銷售額達 1,659 億美元、年增 23.2%。" },
        href: "https://news.tvbs.com.tw/tech/4010067",
        tags: [ { en: "Preview", zh: "展前預告" } ] },

      { date: "2026-09-02", category: "media", lang: "en",
        source: { en: "Focus Taiwan (CNA)", zh: "中央社 Focus Taiwan" },
        title: { en: "Premier highlights Taiwan's key role in global AI development",
                 zh: "卓榮泰開幕致詞：台灣在全球 AI 發展中的關鍵角色" },
        summary: { en: "Opening-day report: Premier Cho Jung-tai told the show that Taiwan's semiconductor production value reached US$209.1 billion in 2025, up 22.7%, and pledged land, energy, talent and financing to keep the industry expanding. SEMI president Ajit Manocha said AI could lift global semiconductor revenue to US$2 trillion by 2030; the show drew more than 1,300 exhibitors from over 60 countries.",
                   zh: "開幕當天的報導：行政院長卓榮泰致詞指出，台灣 2025 年半導體產值達 2,091 億美元、年增 22.7%，政府將在土地、能源、人才與資金上支持產業持續擴張。SEMI 全球總裁 Ajit Manocha 表示 AI 可望推升全球半導體營收在 2030 年達到 2 兆美元；本屆逾 1,300 家展商來自 60 多個國家。" },
        href: "https://focustaiwan.tw/sci-tech/202609020011",
        tags: [ { en: "Opening ceremony", zh: "開幕典禮" }, { en: "Government", zh: "政府" } ] },

      { date: "2026-09-02", category: "media", lang: "en",
        source: { en: "Focus Taiwan (CNA)", zh: "中央社 Focus Taiwan" },
        title: { en: "U.S., U.K., France envoys open national pavilions at 2026 SEMICON Taiwan",
                 zh: "美、英、法駐台代表為國家館揭幕，18 國國家館創紀錄" },
        summary: { en: "Three of the record 18 national pavilions were opened by their envoys on day one. AIT director Raymond Greene said \"the U.S.-Taiwan semiconductor partnership has never been stronger\"; new French Office director Frédéric Laplanche noted a record 10 French participants; the UK's Ruth Bradley-Jones called her delegation \"the biggest group of U.K. companies we've ever had\", focused on photonics and advanced packaging.",
                   zh: "創紀錄的 18 個國家館中，美、英、法三館由駐台代表在開展首日揭幕。AIT 處長谷立言（Raymond Greene）說「美台半導體夥伴關係從未如此堅實」；法國在台協會新任主任 Frédéric Laplanche 指出法國館有創紀錄的 10 家參展單位；英國代表 Ruth Bradley-Jones 稱這是「英國企業歷來最大的參展團」，聚焦光子學與先進封裝。" },
        href: "https://focustaiwan.tw/sci-tech/202609020012",
        tags: [ { en: "National pavilions", zh: "國家館" }, { en: "Geopolitics", zh: "地緣政治" } ] },

      { date: "2026-07-22", category: "media", lang: "zh",
        source: { en: "TechNews", zh: "科技新報 TechNews" },
        title: { en: "SEMICON Taiwan 2026 draws 18 countries; global-zone booths hit a record, up 250% in three years",
                 zh: "SEMICON Taiwan 2026 吸引 18 國參展，展位規模創新高、三年增逾 250%" },
        summary: { en: "From the Global Zone press conference on 22 July: 18 countries and 220 booth spaces in the global zone, up more than 250% since 2023, with Catalonia, Chihuahua and Finland joining for the first time. SEMI Taiwan president Terry Tsao said global AI-infrastructure build-out is reshaping how the industry develops and collaborates; SEMI's forecast put 2026 global equipment sales at US$165.9 billion, up 23.2%, rising to US$229.5 billion by 2028.",
                   zh: "7 月 22 日全球專區記者會的報導：全球專區 18 國參展、220 個攤位，較 2023 年成長逾 250%，西班牙加泰隆尼亞、墨西哥奇瓦瓦州與芬蘭首度加入。SEMI 全球行銷長暨台灣區總裁曹世綸表示，全球 AI 基礎設施擴張正在重塑半導體產業的發展格局與合作模式；SEMI 預估 2026 年全球半導體設備銷售額達 1,659 億美元、年增 23.2%，2028 年上看 2,295 億美元。" },
        href: "https://technews.tw/2026/07/22/semicon-taiwan-2026-media-event/",
        tags: [ { en: "National pavilions", zh: "國家館" }, { en: "Preview", zh: "展前預告" } ] },
      { date: "2026-09-01", category: "media", lang: "en",
        source: { en: "Taipei Times", zh: "Taipei Times" },
        title: { en: "Integrated systems to lead AI boom: TSMC executive",
                 zh: "台積電主管：AI 時代的贏家是做出最整合系統的人" },
        summary: { en: "At the show's IC forum, TSMC's April Li said \"market leaders will not be the ones who simply make better models, but those who build the most integrated systems\". She said global inference token volume has grown roughly 500-fold since 2022, and that moving data now accounts for up to 60% of system activity.",
                   zh: "台積電 April Li 在展會 IC 論壇表示：「市場領先者不會是單純把模型做得更好的人，而是把系統整合得最好的人。」她指出全球推論 token 量自 2022 年以來成長約 500 倍，資料搬移如今占系統活動高達六成。" },
        href: "https://www.taipeitimes.com/News/biz/archives/2026/09/01/2003863452",
        tags: [ { en: "TSMC", zh: "台積電" }, { en: "AI infrastructure", zh: "AI 基礎設施" }, { en: "Forum", zh: "論壇" } ] },

      { date: "2026-09-04", category: "media", lang: "en",
        source: { en: "Digitimes Asia", zh: "Digitimes Asia" },
        title: { en: "TSMC urges HBM makers to design for X-ray inspection as packaging grows more complex",
                 zh: "台積電呼籲 HBM 業者為 X 光檢測而設計：封裝愈複雜，埋藏缺陷愈難抓" },
        summary: { en: "TSMC's Zhihua Zou told the show that HBM and DRAM makers should design their products to be compatible with X-ray inspection: as advanced packaging stacks up, buried defects get harder to find, while the inspection itself must avoid radiation risk to sensitive memory. Full text is behind Digitimes' paywall.",
                   zh: "台積電 Zhihua Zou 在展會上呼籲 HBM 與 DRAM 業者在產品設計階段就考慮與 X 光檢測相容：先進封裝愈疊愈複雜，埋在裡面的缺陷愈難偵測，而檢測本身又得避免輻射傷及敏感的記憶體元件。全文需 Digitimes 訂閱。" },
        href: "https://www.digitimes.com/news/a20260904VL218/tsmc-inspection-hbm-packaging-design.html",
        tags: [ { en: "TSMC", zh: "台積電" }, { en: "HBM", zh: "HBM" }, { en: "Inspection", zh: "檢測" } ] },

      { date: "2026-09-04", category: "media", lang: "en",
        source: { en: "Digitimes Asia", zh: "Digitimes Asia" },
        title: { en: "CPO testing shifts to mid-stage to avoid costly failures, Chroma says",
                 zh: "致茂：CPO 測試往中段移，先篩光學引擎再封裝，避免昂貴的後段失敗" },
        summary: { en: "Jeff Lee, president of Chroma ATE's Photonics & Precision business unit, said chipmakers are pulling co-packaged optics testing earlier in the flow to screen optical engines before final packaging, so that a bad engine is caught before it has been married to an expensive package. Full text is behind Digitimes' paywall.",
                   zh: "致茂電子光電暨精密事業群總經理 Jeff Lee 表示，晶片業者正把 CPO 測試往前挪，在最終封裝前先篩選光學引擎，避免壞的引擎已經和昂貴的封裝結合後才在後段光學測試中被抓出來。全文需 Digitimes 訂閱。" },
        href: "https://www.digitimes.com/news/a20260904VL219/cpo-testing-optics-equipment-chipmakers.html",
        tags: [ { en: "CPO", zh: "CPO" }, { en: "Test", zh: "測試" } ] },

      { date: "2026-09-04", category: "media", lang: "en",
        source: { en: "Digitimes Asia", zh: "Digitimes Asia" },
        title: { en: "From chips to physical AI: Experts urge Taiwan-US push for trusted drone supply chains at Semicon Taiwan 2026",
                 zh: "從晶片到實體 AI：專家籲台美共建可信任的無人機供應鏈" },
        summary: { en: "A show-floor panel argued that supply-chain-security thinking is spreading from chips to drones and other autonomous systems, and urged Taiwan and the US to build trusted drone supply chains together. Only the lede is visible; speaker names and quotes are behind the paywall.",
                   zh: "展會上的一場座談指出，供應鏈安全的思維正從晶片延伸到無人機與其他自主系統，呼籲台美共同打造可信任的無人機供應鏈。僅導言可見，講者姓名與引言在付費牆之後。" },
        href: "https://www.digitimes.com/news/a20260904PD218/drone-semiconductors-government-semicon-taiwan-2026.html",
        tags: [ { en: "Supply chain", zh: "供應鏈" }, { en: "Geopolitics", zh: "地緣政治" } ] },

      { date: "2026-09-05", category: "media", lang: "en",
        source: { en: "Digitimes Asia", zh: "Digitimes Asia" },
        title: { en: "Semicon Taiwan 2026: A windmill in the die bonder, and a Dutch bet on photonics",
                 zh: "固晶機裡的風車，以及荷蘭押注光子學" },
        summary: { en: "Post-show dispatch: Dutch equipment maker ITEC showed a die-bonding architecture that it says \"triples throughput over earlier versions of the design by removing the largest source of idle motion in chip assembly: the return trip\". The Dutch photonics angle in the headline sits behind the paywall.",
                   zh: "展後報導：荷蘭設備商 ITEC 展出的固晶架構，據其說法「把晶片組裝中最大的空轉來源——回程——拿掉後，產能較先前版本提高三倍」。標題中荷蘭押注光子學的部分在付費牆之後。" },
        href: "https://www.digitimes.com/news/a20260904VL220/dutch-wafer-packaging-photonics-semicon-taiwan.html",
        tags: [ { en: "Equipment", zh: "設備" }, { en: "Netherlands", zh: "荷蘭" }, { en: "Photonics", zh: "光子學" } ] },

      { date: "2026-09-05", category: "media", lang: "en",
        source: { en: "Digitimes Asia", zh: "Digitimes Asia" },
        title: { en: "Taiwan semiconductor output targets NT$8 trillion",
                 zh: "經濟部：台灣半導體產值上看 8 兆元" },
        summary: { en: "As the show opened at Nangang, the Ministry of Economic Affairs said Taiwan's semiconductor industry output could exceed NT$8 trillion, citing forecasts from multiple research institutions. The year the figure refers to, and which institutions, are behind the paywall.",
                   zh: "展會在南港開幕之際，經濟部表示依多家研究機構的預測，台灣半導體產業產值可望突破新台幣 8 兆元。該數字對應的年份與引用的機構在付費牆之後。" },
        href: "https://www.digitimes.com/news/a20260904PD237/taiwan-semiconductors-equipment-development-moea-taipei.html",
        tags: [ { en: "Government", zh: "政府" }, { en: "Forecast", zh: "預測" } ] },

      { date: "2026-09-04", category: "media", lang: "en",
        source: { en: "Focus Taiwan (CNA)", zh: "中央社 Focus Taiwan" },
        title: { en: "Nordic R&D expertise can strengthen Taiwan's chip sector: Panelists",
                 zh: "北歐研發能量可補強台灣晶片業：座談與會者" },
        summary: { en: "A closing-day panel argued that Nordic research strengths complement Taiwan's manufacturing scale. SEMI's Terry Tsao said \"Europe has expertise in advanced research, materials, compound semiconductors\" while Taiwan excels at scaling and mass production; MediaTek's recruiting of Finnish and Swedish engineers was cited as an example of the two sides already meeting.",
                   zh: "閉幕日的一場座談主張北歐的研究強項可與台灣的製造規模互補。SEMI 曹世綸表示「歐洲在先進研究、材料與化合物半導體有專長」，台灣則擅長放大與量產；聯發科延攬芬蘭與瑞典工程師被舉為雙方已在對接的例子。" },
        href: "https://focustaiwan.tw/sci-tech/202609040011",
        tags: [ { en: "Europe", zh: "歐洲" }, { en: "Talent", zh: "人才" }, { en: "Forum", zh: "論壇" } ] },

      { date: "2026-09-04", category: "media", lang: "en",
        source: { en: "Focus Taiwan (CNA)", zh: "中央社 Focus Taiwan" },
        title: { en: "Taiwan, Lithuania sign pact on advanced packaging for next-gen chips",
                 zh: "台灣與立陶宛簽署次世代晶片先進封裝合作備忘錄" },
        summary: { en: "On the show's final day Taiwan and Lithuania signed an MOU to jointly develop advanced-packaging equipment, pairing Lithuanian laser expertise with Taiwanese imaging and AI. ITRI president Chang Pei-zen said the aim is to \"get private businesses to jointly develop advanced chip packaging equipment\"; the two governments will contribute 5.6 million euros over two years.",
                   zh: "展會最後一天，台灣與立陶宛簽署合作備忘錄，結合立陶宛的雷射專長與台灣的影像及 AI 能力，共同開發先進封裝設備。工研院院長張培仁說目標是「讓民間企業共同開發先進晶片封裝設備」；兩國政府將在兩年內投入 560 萬歐元。" },
        href: "https://focustaiwan.tw/business/202609040012",
        tags: [ { en: "Advanced packaging", zh: "先進封裝" }, { en: "Lithuania", zh: "立陶宛" }, { en: "MOU", zh: "合作備忘錄" } ] },

      { date: "2026-09-05", category: "media", lang: "en",
        source: { en: "Focus Taiwan (CNA)", zh: "中央社 Focus Taiwan" },
        title: { en: "Made in Taiwan, sovereign in Europe: France's different chip strategy",
                 zh: "台灣製造、歐洲主權：法國走不一樣的晶片路線" },
        summary: { en: "A semiconductor-week feature on an event held the day before the show opened. French President Emmanuel Macron has publicly acknowledged using Taiwan-made chips for European applications; SiPearl CEO Philippe Notton said \"three years earlier, hearing this chip is coming from Taiwan would have been almost impossible\", describing a strategy that keeps R&D and design in France while relying on Taiwan for manufacturing, such as CEA-Leti's partnership with Powerchip.",
                   zh: "半導體週的特寫，報導開展前一天的一場活動。法國總統馬克宏已公開承認歐洲應用採用台灣製造的晶片；SiPearl 執行長 Philippe Notton 說「三年前，聽到這顆晶片來自台灣幾乎是不可能的事」，並描述法國把研發與設計留在國內、製造倚賴台灣的策略，例如 CEA-Leti 與力積電的合作。" },
        href: "https://focustaiwan.tw/business/202609050008",
        tags: [ { en: "Europe", zh: "歐洲" }, { en: "Geopolitics", zh: "地緣政治" } ] },

      { date: "2026-09-02", category: "media", lang: "zh",
        source: { en: "NOWnews", zh: "NOWnews 今日新聞" },
        title: { en: "Fireside chat: Foxconn's Young Liu wants \"made with Taiwan\", not \"made in Taiwan\"",
                 zh: "SEMICOM爐邊對談 劉揚偉：不要求「在台生產」而是「與台生產」" },
        summary: { en: "Report on the master-forum fireside chat moderated by ASE's Tien Wu with TSMC's Cliff Hou, MediaTek's Rick Tsai and Foxconn's Young Liu. Liu argued Taiwan should move from \"Made in Taiwan\" to \"Made with Taiwan\"; Hou said equipment demand went from baseline to 1.9× within six months, with TSMC building close to 20 fabs at once.",
                   zh: "大師論壇爐邊對談的報導：日月光投控營運長吳田玉主持，與台積電資深副總侯永清、聯發科副董事長暨執行長蔡力行、鴻海董事長劉揚偉對談。劉揚偉主張台灣應從「Made in Taiwan」走向「Made with Taiwan」；侯永清透露設備需求半年內從基準值衝到 1.9 倍，台積電同時在建近 20 座晶圓廠。" },
        href: "https://www.nownews.com/news/6871629",
        tags: [ { en: "Fireside chat", zh: "爐邊對談" }, { en: "Foxconn", zh: "鴻海" }, { en: "TSMC", zh: "台積電" } ] },

      { date: "2026-09-02", category: "media", lang: "zh",
        source: { en: "SETN", zh: "三立新聞網 SETN" },
        title: { en: "Master forum chat: TSMC and MediaTek name Taiwan's bottlenecks",
                 zh: "半導體大師對談　台積、聯發科曝台灣瓶頸" },
        summary: { en: "Another angle on the same 2 September fireside chat: TSMC's Cliff Hou said equipment purchases jumped from baseline to 1.5× within a quarter and 1.9× by July, and that TSMC is building 13 fabs in Taiwan plus five or six overseas — close to 20 at once versus four or five in earlier cycles — which is why land, power, people, equipment and materials all have to scale together.",
                   zh: "同一場 9/2 爐邊對談的另一角度：台積電侯永清透露設備採購一季內從基準值衝到 1.5 倍、7 月已達 1.9 倍；台積電在台同時興建 13 座晶圓廠，加上海外 5、6 座近 20 座，遠超以往同時期 4、5 座的規模，因此土地、電力、人力、設備、材料必須同步擴張。" },
        href: "https://www.setn.com/news/1900552",
        tags: [ { en: "Fireside chat", zh: "爐邊對談" }, { en: "TSMC", zh: "台積電" }, { en: "Capacity", zh: "產能" } ] },

      { date: "2026-09-02", category: "media", lang: "zh",
        source: { en: "Global Views Monthly", zh: "遠見雜誌" },
        title: { en: "AI bubble? WinWay executive: everyone has it backwards — the choke point is a supply chain that can't ship",
                 zh: "AI泡沫化了？穎崴高層：大家搞錯重點，卡關在供應鏈交不出貨" },
        summary: { en: "Interviewed at the show, WinWay vice president Chen Shao-kun said the problem is supply, not demand: test-interface pin counts have gone from 5,000–6,000 to over 10,000 and lead times from 8 weeks to 13–14, with capacity expected to grow another ~50% after mid-2027. The company has more than ten CPO projects in hand, with small shipments in the second half of 2027 and volume in 2028.",
                   zh: "穎崴副總陳紹焜在展會受訪表示，現在面臨的不是需求問題而是供應問題：測試介面針數已從 5,000～6,000 根衝上逾萬根，交期從 8 週拉長到 13～14 週，預期 2027 年中後產能可再增約五成。手上 CPO 專案十多個，2027 年下半年小量出貨、2028 年放量。" },
        href: "https://www.gvm.com.tw/article/132806",
        tags: [ { en: "Test", zh: "測試" }, { en: "CPO", zh: "CPO" }, { en: "Capacity", zh: "產能" } ] },

      { date: "2026-09-04", category: "media", lang: "zh",
        source: { en: "TechNews", zh: "科技新報 TechNews" },
        title: { en: "ITRI teams up with Lithuania on high-power ultrafast lasers for AI packaging and next-gen chips",
                 zh: "引進高功率超快雷射！工研院攜手立陶宛布局 AI 先進封裝與次世代半導體" },
        summary: { en: "ITRI signed an MOU with Lithuania during the show to bring in high-power laser technology. MOEA official Kuo Chao-chung said the cooperation has generated NT$1.5 billion of output since 2023; ITRI president Chang Pei-zen said the targets are AI-server cooling, fibre arrays, and SiC and diamond substrates. Taiwan is putting in 5.6 million euros over two years and expects more than NT$500 million of industrial benefit within five.",
                   zh: "工研院在展會期間與立陶宛簽署合作備忘錄，引進當地高功率雷射技術。經濟部官員郭肇中表示此合作自 2023 年來已創造 15 億元產值；工研院院長張培仁指出鎖定 AI 伺服器散熱、光纖陣列、SiC 與鑽石基板。台灣兩年投入 560 萬歐元，預期五年內帶動逾 5 億元產業效益。" },
        href: "https://technews.tw/2026/09/04/high-power-ultrafast-laser/",
        tags: [ { en: "Advanced packaging", zh: "先進封裝" }, { en: "Lithuania", zh: "立陶宛" }, { en: "MOU", zh: "合作備忘錄" } ] },

      { date: "2026-09-03", category: "media", lang: "zh",
        source: { en: "DIGITIMES (Chinese)", zh: "電子時報 DIGITIMES" },
        title: { en: "A hundred-strong machinery contingent at SEMICON 2026: the association wants to incubate a home-grown equipment chain",
                 zh: "百家陣容參展SEMICON 2026　機械公會盼孵化國產半導體設備鏈" },
        summary: { en: "Since the precision machinery association first set up its own pavilion in 2024, its exhibitor count has grown from a dozen or so to more than a hundred. The association hopes the pavilion incubates a domestic semiconductor-equipment supply chain and shows how much Taiwan's precision-machinery sector matters to its chip industry. Full text is behind DIGITIMES membership.",
                   zh: "精密機械公會自 2024 年首設機械專館以來，參展規模從十幾家成長到破百家。公會盼藉此孵化國產半導體設備供應鏈，凸顯台灣精密機械業對半導體發展的重要性。全文需會員登入。" },
        href: "https://www.digitimes.com.tw/tech/dt/n/shwnws.asp?id=0000767342_ITT4I0RS3ECZP53P9AIHK",
        tags: [ { en: "Equipment", zh: "設備" }, { en: "Local supply chain", zh: "國產供應鏈" } ] },

      { date: "2026-09-03", category: "media", lang: "en",
        source: { en: "The Quantum Insider", zh: "The Quantum Insider" },
        title: { en: "SEEQC signs MOU to expand quantum technology cooperation in Taiwan",
                 zh: "SEEQC 與台灣量子產業技術推動辦公室簽署合作備忘錄，擴大量子技術合作" },
        summary: { en: "Reporting SEEQC's announcement: CTO Dr. Shu-Jen Han signed an MOU with Taiwan's Quantum Industry Technology Promotion Office during SEMICON Taiwan 2026, setting a framework for collaboration across technology and product development, manufacturing, testing and validation, commercialisation and supply-chain development for its cryo-CMOS and SFQ quantum platform. Han also spoke at the Quantum Taiwan Forum alongside IBM, Fujitsu, Google, NVIDIA, Xanadu and D-Wave.",
                   zh: "報導 SEEQC 的公告：技術長 Shu-Jen Han 於 SEMICON Taiwan 2026 期間與台灣量子產業技術推動辦公室簽署合作備忘錄，建立涵蓋技術與產品開發、製造、測試驗證、商業化與供應鏈發展的合作架構，對象是其低溫 CMOS 與 SFQ 量子運算平台。Han 亦在量子論壇與 IBM、富士通、Google、NVIDIA、Xanadu、D-Wave 同台。" },
        href: "https://thequantuminsider.com/2026/09/03/seeqc-mou-quantum-technology-cooperation-taiwan/",
        tags: [ { en: "Quantum", zh: "量子" }, { en: "MOU", zh: "合作備忘錄" } ] },
...
/* ---------------- vendor ---------------- */
      ...
      { date: "2026-08-31", category: "vendor", lang: "zh",
        source: { en: "TechNews", zh: "科技新報 TechNews" },
        title: { en: "Corning shows advanced optical and glass solutions at SEMICON Taiwan, from CPO to glass substrates",
                 zh: "康寧 SEMICON Taiwan 大秀先進光學技術，聚焦 CPO、玻璃基板等新解方" },
        summary: { en: "Corning showed glass and materials aimed squarely at chipmaking: ultra-low-expansion glass for EUV/DUV lithography, high-performance glass for fan-out panel-level and 3D packaging, optical solutions for co-packaged optics, and glass-core substrates built on through-glass vias. Development director Chiang Chen-kuo said advanced packaging, heterogeneous integration and AI keep raising the bar for semiconductor materials.",
                   zh: "康寧展出鎖定半導體製造的玻璃與材料方案：EUV/DUV 微影用超低膨脹玻璃、面板級扇出與 3D 封裝用高性能玻璃、支援 CPO 的光學方案，以及採 TGV 玻璃通孔架構的玻璃核心基板。康寧發展總監蔣振國表示，業界持續聚焦先進封裝、異質整合與 AI 應用，對半導體材料提出更嚴格的標準。" },
        href: "https://technews.tw/2026/08/31/corning-semicon-taiwan-2026",
        tags: [ { en: "Materials", zh: "材料" }, { en: "Glass substrate", zh: "玻璃基板" }, { en: "CPO", zh: "CPO" } ] },
      { date: "2026-09-04", category: "vendor", lang: "zh",
        source: { en: "TechNews (Finance)", zh: "科技新報 財經新報" },
        title: { en: "Giant Wave shows smart high-safety gas cabinets at SEMICON, starts IPO coaching with NT$3bn order book",
                 zh: "巨茂 SEMICON 秀智能高安全氣櫃！挾 30 億在手訂單啟動上市櫃輔導" },
        summary: { en: "Giant Wave showed its smart high-safety gas-cabinet system at the show. CEO Lee Chun-wei said orders in hand exceed NT$3 billion and run through mid-2027, and that the company has started listing coaching with Fubon Securities.",
                   zh: "巨茂在展會展出智能高安全氣櫃系統。執行長李俊緯表示在手訂單逾 30 億元、可執行到 2027 年中，並已啟動與富邦證券的上市櫃輔導。" },
        href: "https://finance.technews.tw/2026/09/04/turnkey-solution/",
        tags: [ { en: "Fab facilities", zh: "廠務" }, { en: "IPO", zh: "上市櫃" } ] },

      { date: "2026-09-04", category: "vendor", lang: "zh",
        source: { en: "DIGITIMES (Chinese)", zh: "電子時報 DIGITIMES" },
        title: { en: "Automotive SoCs are tightly locked in; Hongsuan bets its \"AI chiplets\" become the automotive mainstream",
                 zh: "汽車SoC受高度綁定　鴻軒深耕「AI小晶片」看好成車用主流" },
        summary: { en: "Hongsuan showed automotive MCUs and AI chips at the show. CEO Liu Chin-yun noted that IC-design houses rarely exhibit at SEMICON, and argued that \"AI chiplets\" will displace today's tightly bound automotive SoCs as the mainstream approach. Full text is behind DIGITIMES membership.",
                   zh: "鴻軒在展會展出車用 MCU 與 AI 晶片。執行長劉錦運表示 IC 設計業者較少在 SEMICON 設展，並看好「AI 小晶片」將取代現行高度綁定的車用 SoC，成為車用主流方案。全文需會員登入。" },
        href: "https://www.digitimes.com.tw/tech/dt/n/shwnws.asp?id=0000767172_BPL2NMTM6YT1OQ3QT4CCV",
        tags: [ { en: "Automotive", zh: "車用" }, { en: "Chiplets", zh: "小晶片" } ] },

      { date: "2026-09-01", category: "vendor", lang: "en",
        source: { en: "PR Newswire · Kulicke & Soffa", zh: "PR Newswire · Kulicke & Soffa" },
        title: { en: "Kulicke & Soffa advances AI infrastructure through co-packaged optics and advanced packaging",
                 zh: "K&S：以 CPO 與先進封裝推進 AI 基礎設施，SEMICON Taiwan 展出 Advanced Solutions" },
        summary: { en: "Pre-show release: K&S said its fluxless thermo-compression bonding supports emerging co-packaged optics for AI infrastructure, enabling higher-bandwidth, more energy-efficient networking, and that it would showcase key features of its expanding Advanced Solutions portfolio at SEMICON Taiwan on 2–4 September.",
                   zh: "展前新聞稿：K&S 表示其無助焊劑熱壓接合（fluxless TCB）可支援 AI 基礎設施新興的 CPO 應用，帶來更高頻寬、更省電的網路連接，並將於 9 月 2 至 4 日的 SEMICON Taiwan 展出其 Advanced Solutions 產品組合的重點。" },
        href: "https://www.prnewswire.com/news-releases/kulicke--soffa-advances-ai-infrastructure-through-co-packaged-optics-cpo-and-advanced-packaging-leadership-302865846.html",
        tags: [ { en: "CPO", zh: "CPO" }, { en: "Advanced packaging", zh: "先進封裝" } ] },

      { date: "2026-09-02", category: "vendor", lang: "zh",
        source: { en: "SEMICON Taiwan exhibitor press platform · Hypersonic", zh: "官方展商新聞稿平台 · 瀚軒" },
        title: { en: "Hypersonic links global partners into a packaging, test, materials and smart-manufacturing platform",
                 zh: "串聯全球策略夥伴 瀚軒打造半導體封裝、測試、材料與智慧製造技術平台" },
        summary: { en: "Filed on SEMI's official exhibitor press-release system (booth N0762): Hypersonic (TWSE 7894) said it is showing packaging, test, materials, in-house equipment and automation-integration solutions, positioning itself as the bridge between global equipment and materials partners and local process-integration service for AI, HPC and advanced-packaging customers.",
                   zh: "刊於 SEMI 官方展商新聞稿系統（攤位 N0762）：瀚軒（7894）表示本屆展出封裝、測試、材料、自製設備與自動化整合方案，定位為連結全球設備與材料夥伴和在地製程整合服務的橋樑，服務 AI、HPC 與先進封裝客戶。" },
        href: "https://expo.semi.org/taiwan2026/Public/eBooth.aspx?BoothID=655995&Task=PressReleases&PrID=13573",
        tags: [ { en: "Advanced packaging", zh: "先進封裝" }, { en: "Test", zh: "測試" } ] },

      { date: "2026-09-01", category: "vendor", lang: "en",
        source: { en: "SEMICON Taiwan exhibitor press platform · DAS Environmental Expert", zh: "官方展商新聞稿平台 · DAS Environmental Expert" },
        title: { en: "DAS Environmental Experts introduces ALCEA for integrated NOx treatment in semiconductor fabs",
                 zh: "DAS Environmental Experts 推出 ALCEA：整合進排氣管路的晶圓廠 NOx 處理系統" },
        summary: { en: "Dresden-based DAS launched ALCEA, a plasma-enhanced catalytic secondary NOx abatement system that sits directly in the exhaust duct, cutting subfab floor space and energy demand while reducing NOx emissions by up to 95%. Developed with ITRI and shown at booth J2346.",
                   zh: "來自德勒斯登的 DAS 發表 ALCEA——電漿強化的觸媒式二次 NOx 削減系統，直接整合在排氣管路中，減少 subfab 占地與能耗，NOx 排放最多可降 95%。與工研院合作開發，於 J2346 攤位展出。" },
        href: "https://expo.semi.org/taiwan2026/Public/eBooth.aspx?BoothID=651527&Task=PressReleases&PrID=13568",
        tags: [ { en: "Fab facilities", zh: "廠務" }, { en: "Sustainability", zh: "永續" } ] },
...
/* ---------------- social ---------------- */
      ...
      { date: "2026-09-02", category: "social", lang: "en",
        source: { en: "YouTube · ET Digital", zh: "YouTube · ET Digital" },
        title: { en: "Taiwan: Semicon Network Summit 2026 drives global semiconductor partnerships",
                 zh: "影音：Semicon Network Summit 2026 推動全球半導體夥伴關係" },
        summary: { en: "A news video on the Semicon Network Summit held in Taipei on 1 September — the government-and-industry forum co-organised by ITRI and SEMI that runs alongside the show during International Semiconductor Week. It covers the summit rather than the exhibition floor itself.",
                   zh: "報導 9 月 1 日在台北舉行的 Semicon Network Summit 的新聞影片——這是工研院與 SEMI 共同主辦、在國際半導體週期間與展會並行的政府暨產業論壇。內容聚焦峰會，不是展場本身。" },
        href: "https://www.youtube.com/watch?v=0U2pDOxv77Y",
        tags: [ { en: "Video", zh: "影音" }, { en: "Network Summit", zh: "Network Summit" } ] },

...
window.SITE_PAGES = [
   ...
   * ===================================================================== */
  {
    ...
    highlights: [
      ...
      { lang: "en", src: "/assets/highlights/en-3-pivot.webp",
        caption: { en: "The great pivot, sketched", zh: "大轉向．插畫版（英文）" },
        alt: { en: "English infographic in a sketched, sepia illustration style titled The Great Pivot: from manufacturing to AI infrastructure. A balance scale tips from traditional manufacturing toward AI infrastructure assembly. Left column of highlights: Google's AI infrastructure chief debuting in Asia, silicon photonics and CPO taking centre stage to address data-transmission bottlenecks, the capacity ceiling of advanced packaging with a Chiplet pavilion, and quantum plus smart fab as new standalone zones. Centre: the US$1 trillion year arriving four years early, with 2030 struck through for 2026, and a US$2 trillion market forecast. Right: a record-breaking global pavilion with the highest number of countries ever. Stat strip: 1,300+ exhibitors, 4,300+ booths, 65 participating countries, 18 national pavilions, 100,000+ professional visitors.",
               zh: "英文資訊圖，復古手繪插畫風格，標題 The Great Pivot：從製造走向 AI 基礎設施。畫面中央一座天平從傳統製造傾向 AI 基礎設施的組建。左欄亮點：Google AI 基礎設施長亞洲首講、矽光子與 CPO 站上舞台中央以解決資料傳輸瓶頸、先進封裝的產能天花板與 Chiplet 專區、量子與晶圓智造成為新的獨立特區。中段：1 兆美元之年提前四年到來，2030 被劃掉改為 2026，並預測市場規模上看 2 兆美元。右欄：國家館數量創歷年新高的全球專區。數字帶：1,300+ 展商、4,300+ 攤位、65 個參與國家、18 個國家館、100,000+ 專業觀眾人次。" } },

      { lang: "en", src: "/assets/highlights/en-4-evolution.webp",
        caption: { en: "The evolution, in neon", zh: "AI 基礎設施演進．霓虹版（英文）" },
        alt: { en: "English infographic in a blue neon style titled SEMICON Taiwan 2026: The AI Infrastructure Evolution, subtitled the chip show became an AI-infrastructure show. Headline figures: the US$1 trillion year arrived four years early after SEMI moved the global revenue milestone to 2026 on AI demand, with a new target of US$2 trillion by 2030. Five panels: the pivot to AI infrastructure with Google, NVIDIA and Microsoft on the main stage; Google's AI infrastructure chief Amin Vahdat delivering his first public keynote in Asia; silicon photonics and CPO integration as the main theme for AI-cluster connectivity; advanced packaging and the Chiplet pavilion with the bottleneck shifting from demand to capacity; and quantum plus smart fab established as dedicated zones for the first time. Stat strip: 1,300+ exhibitors, 4,300+ booths, 65 participating countries, 18 international pavilions, 100,000+ professional visitors.",
               zh: "英文資訊圖，藍色霓虹風格，標題 SEMICON Taiwan 2026: The AI Infrastructure Evolution，副標「晶片展變成了 AI 基礎設施展」。主打數字：SEMI 因 AI 需求將全球營收 1 兆美元里程碑提前至 2026 年，等於提前四年達成，並設定 2030 年 2 兆美元的新目標。五個區塊：轉向 AI 基礎設施，Google、NVIDIA 與微軟站上主舞台；Google AI 基礎設施長 Amin Vahdat 在亞洲的首場公開 keynote；矽光子與 CPO 整合成為 AI 叢集連線的主旋律；先進封裝與 Chiplet 專區，瓶頸從需求轉向產能；量子與晶圓智造首度設為獨立特區。數字帶：1,300+ 展商、4,300+ 攤位、65 個參與國家、18 個國際館、100,000+ 專業觀眾人次。" } }
    ],
    ...
    takeaways: [
      { icon: "hub",
        ...
        body: { en: "Cloud and hyperscaler names — Google, Microsoft, Nvidia, Broadcom, Meta, Micron — took top billing alongside TSMC, MediaTek and ASE for the first time. Google's Amin Vahdat opened the CEO Forum with his first public keynote in Asia, and used it to announce a 60% expansion of Google's Shilin R&D centre, calling Taiwan its largest hardware engineering base outside the US.",
                zh: "雲端與超大規模業者——Google、微軟、輝達、博通、Meta、美光——首度與台積電、聯發科、日月光並列主舞台。Google 的 Amin Vahdat 以其亞洲首場公開主題演講揭開 CEO 論壇，並於台上宣布擴建士林研發中心、辦公空間增加 60%，稱台灣是 Google 在美國以外最大的硬體工程研發基地。" } },
      { icon: "lightbulb",
    ...
    items: [
      ...
      { date: "2026-09-02", category: "media", lang: "zh",
        source: { en: "Business Next", zh: "數位時代" },
        title: { en: "Google expands its Shilin R&D centre by 60%, confirms Taiwan as its largest hardware engineering base outside the US",
                 zh: "Google 擴建士林研發中心，辦公空間增 60%：台灣是美國以外最大硬體工程基地" },
        summary: { en: "The concrete announcement out of Amin Vahdat's keynote. Taiwan's team brings up and validates new silicon the moment it comes off TSMC's line, and TPU cadence has gone from one generation every two years to two in the past year.",
                   zh: "Amin Vahdat 主題演講中的具體宣布。台灣團隊負責新晶片下線後的啟動、測試與軟體驗證——「當晶片第一次從台積電產線出來時，就是我們當地團隊進行非常繁複的工作」；TPU 推出節奏已從兩年一代加快到近一年內推出兩代。" },
        href: "https://www.bnext.com.tw/article/92096/google-amin-vahdat-2026-semicon",
        tags: [ { en: "Keynote", zh: "主題演講" }, { en: "AI infrastructure", zh: "AI 基礎設施" } ] },

      { date: "2026-09-02", category: "media", lang: "zh",
        source: { en: "CNA", zh: "中央社 CNA" },
        title: { en: "Taiwanese firms added US$20bn of US investment in three months, taking the total to US$55bn",
                 zh: "台廠赴美投資升溫，經長：近 3 月額外追加 200 億美元" },
        summary: { en: "The precise version of the investment number: 20 companies had pledged US$35bn, and roughly US$20bn more was added over the past three months, bringing the running total to about US$55bn.",
                   zh: "投資數字的精確版本：原有 20 家企業的 350 億美元投資計畫，近三個月再追加約 200 億美元，總規模達 550 億美元。" },
        href: "https://www.cna.com.tw/news/afe/202609020227.aspx",
        tags: [ { en: "Policy", zh: "政策" }, { en: "Investment", zh: "投資" } ] },

      { date: "2026-09-02", category: "media", lang: "zh",
        source: { en: "Liberty Times", zh: "自由財經" },
        title: { en: "Deloitte flags three trends to watch at the show",
                 zh: "勤業眾信提醒關注 3 大趨勢" },
        summary: { en: "An advisory read on the same show floor: technology integration (chiplets, HBM, CPO), building core capability rather than just adding capacity, and whether suppliers follow their customers overseas as supply chains reorganize.",
                   zh: "顧問視角的三大趨勢：技術整合（Chiplet／HBM／CPO）、核心能力建構（從擴產轉向掌握關鍵技術），以及全球供應鏈重組下「要不要跟客戶出海」的抉擇。" },
        href: "https://ec.ltn.com.tw/article/breakingnews/5560753",
        tags: [ { en: "Analysis", zh: "產業分析" } ] },

      { date: "2026-09-02", category: "media", lang: "zh",
        source: { en: "Digitimes", zh: "DIGITIMES 中文" },
        title: { en: "A record show, pitched as a whole-value-chain play for the AI era",
                 zh: "SEMICON Taiwan 規模再創高，拚出 AI 時代全價值鏈新契機" },
        summary: { en: "The Chinese-language overview of the show: 1,300 companies and 4,300 booths, both records, spanning advanced packaging, AI chips and optical communications end to end.",
                   zh: "中文版總覽：以「Transform Tomorrow 共構未來」為主軸，1,300 家企業、4,300 個攤位雙創新高，涵蓋先進封裝、AI 晶片與光通訊的完整價值鏈。" },
        href: "https://www.digitimes.com.tw/tech/dt/n/shwnws.asp?id=0000763277_RPU1GTLD8QRPEL6BPNEK5",
        tags: [ { en: "Scale", zh: "展會規模" } ] },

      { date: "2026-09-01", category: "media", lang: "zh",
        source: { en: "Liberty Times", zh: "自由財經" },
        title: { en: "President Lai hands out economic contribution medals at the Chip Chain Summit",
                 zh: "賴清德：台灣半導體實力正在世界各地形成新的產業連結" },
        summary: { en: "The Chinese account of the summit, held at Nangang Hall 2 alongside the show: the president awarded economic contribution medals to the chair of GlobalWafers/Sino-American Silicon and to Micron's CEO, citing Nvidia's annual Taiwan procurement of over NT$3tn and Micron's over NT$1.4tn of local investment.",
                   zh: "同期於南港二館舉行的「2026 晶鏈高峰論壇」中文報導：總統頒發經濟貢獻獎章給環球晶／中美矽晶董事長許秀蓮與美光執行長，並提及輝達每年在台採購投資逾 3 兆元、美光在台投資逾 1.4 兆元。" },
        href: "https://ec.ltn.com.tw/article/breakingnews/5558939",
        tags: [ { en: "Opening", zh: "開幕" }, { en: "Awards", zh: "獎項" } ] },

      { date: "2026-08-31", category: "media", lang: "zh",
        source: { en: "Liberty Times", zh: "自由時報" },
        title: { en: "A talent summit on the eve of the show: US$20m to Arizona and more Fulbright places at NYCU",
                 zh: "SEMICON 揭幕前夕辦人才峰會，谷立言：台美關係從未如此強健" },
        summary: { en: "The workforce thread the show usually only gestures at: at a semiconductor talent summit the AIT director announced a US$20m gift to the University of Arizona to support students studying in Taiwan, and two more Fulbright semiconductor scholars heading to NYCU next year.",
                   zh: "展會平常只帶過的人才議題在此被具體化：美國在台協會處長於半導體人才培育高峰會宣布，亞利桑那大學獲 2,000 萬美元捐款支持學生赴台留學，傅爾布萊特半導體獎學金明年再送兩名研究生赴陽明交大。" },
        href: "https://news.ltn.com.tw/news/politics/breakingnews/5557868",
        tags: [ { en: "Talent", zh: "人才培育" }, { en: "Policy", zh: "政策" } ] },

      { date: "2026-08-30", category: "media", lang: "zh",
        source: { en: "CNA", zh: "中央社 CNA" },
        title: { en: "Where Taiwan's silicon photonics actually stands — TSMC, UMC, Foxconn and Largan by name",
                 zh: "國際半導體展聚焦矽光子及 CPO，台積電 COUPE 量產受矚" },
        summary: { en: "Concrete progress rather than roadmaps: TSMC's CPO solutions entering production this year on the COUPE platform, UMC's Singapore fab shipping its first volume silicon photonics wafers with SILITH, Foxconn's CPO switches ramping through Q3, and Largan setting up its first CPO pilot line.",
                   zh: "不是路線圖而是實際進度：台積電 COUPE 平台相關 CPO 方案今年開始生產；聯電新加坡廠與新加坡商 SILITH 完成首批量產矽光子晶圓交付；鴻海 CPO 交換機預計第 3 季逐步交貨；大立光計畫 9 月前設立第 1 條 CPO 自動化試產線。" },
        href: "https://www.cna.com.tw/news/afe/202608300034.aspx",
        tags: [ { en: "Silicon photonics", zh: "矽光子" }, { en: "Supply chain", zh: "供應鏈" } ] },

      { date: "2026-08-30", category: "media", lang: "zh",
        source: { en: "UDN", zh: "聯合新聞網" },
        title: { en: "The Chinese-language framing: three main threads for this year",
                 zh: "SEMICON 9 月 2 日登場，聚焦 3 大主軸" },
        summary: { en: "How Taiwanese media summarised the programme before it opened: advanced packaging and heterogeneous integration, silicon photonics, and panel-level fan-out packaging.",
                   zh: "台灣媒體展前對議程的歸納，三大主軸為先進封裝與異質整合、矽光子技術，以及面板級扇出型封裝（FOPLP）。" },
        href: "https://udn.com/news/story/7240/9722270",
        tags: [ { en: "Preview", zh: "展前導覽" } ] },

      { date: "2026-08-25", category: "media", lang: "zh",
        source: { en: "UDN", zh: "聯合新聞網" },
        title: { en: "The stock exchange sets up an innovation-board booth for four chip startups",
                 zh: "半導體大展，創新板開趴" },
        summary: { en: "An angle the international coverage missed entirely: Taiwan's stock exchange took floor space in Hall 2 to showcase four innovation-board semiconductor companies — FPGA chips, precursor materials, AI chip design security and solid-state MEMS speakers — and to talk listing with them.",
                   zh: "國際報導完全沒碰的角度：證交所在南港二館 7 樓設創新板展區，帶四家半導體創新企業（FPGA 晶片、前驅物材料、AI 晶片設計資安、固態 MEMS 揚聲器）參展，並提供上市諮詢與投資人交流。" },
        href: "https://udn.com/news/story/7251/9713762",
        tags: [ { en: "Startups", zh: "新創" }, { en: "Capital markets", zh: "資本市場" } ] },

      { date: "2026-08-25", category: "media", lang: "zh",
        source: { en: "CNA", zh: "中央社 CNA" },
        title: { en: "Badge pickup at five high-speed rail stations, stitching the tech corridor together",
                 zh: "國際半導體展迎 10 萬訪客，高鐵 5 站領證串聯科技聚落" },
        summary: { en: "A practical detail worth knowing before you go: SEMI worked with Taiwan High Speed Rail so badges could be collected at the Taoyuan, Hsinchu, Taichung, Tainan and Kaohsiung stations, rather than only on site.",
                   zh: "出發前值得知道的實務細節：SEMI 與台灣高鐵合作，桃園、新竹、台中、台南、高雄五站皆可領證，不必只在現場排隊。" },
        href: "https://www.cna.com.tw/news/afe/202608250240.aspx",
        tags: [ { en: "Visiting", zh: "參觀資訊" } ] },
      ...
      { date: "2026-09-03", category: "vendor", lang: "zh",
        source: { en: "Anue Cnyes", zh: "鉅亨網" },
        title: { en: "Yuchen sells clean air by subscription: regenerable chemical filters",
                 zh: "鈺祥展出循環再生、AI 智慧製造、氣液整合三大布局" },
        summary: { en: "A smaller Taiwanese supplier's angle on sustainability — regenerable chemical filters sold as a 'clean air subscription' rather than as consumables. First-half revenue was up 53.1% year on year.",
                   zh: "台灣中小型供應商的永續切法——把再生型化學濾網做成「潔淨空氣訂閱制」而非耗材銷售。上半年合併營收年增 53.1%，7 月創單月新高。" },
        href: "https://news.cnyes.com/news/id/6596147",
        tags: [ { en: "Sustainability", zh: "永續" }, { en: "Taiwan supplier", zh: "台廠" } ] },

      { date: "2026-09-02", category: "vendor", lang: "zh",
        source: { en: "Anue Cnyes", zh: "鉅亨網" },
        title: { en: "Tongtai's semiconductor and electronics share rises to 40% on localisation and AI servers",
                 zh: "東台半導體與電子業務占比升至 4 成，下半年營運優於上半年" },
        summary: { en: "A machine-tool maker repositioning into the chip supply chain: its chairman put semiconductor and electronics at 40% of business, driven by domestic substitution and demand for thick plate in AI servers.",
                   zh: "工具機廠轉向半導體供應鏈：董事長表示半導體與電子業務占比已升至 40%，受惠國產替代與 AI 伺服器厚板需求，下半年營運優於上半年。" },
        href: "https://news.cnyes.com/news/id/6595308",
        tags: [ { en: "Taiwan supplier", zh: "台廠" }, { en: "Equipment", zh: "設備" } ] },
      ...
      { date: "2026-09-02", category: "social", lang: "zh",
        source: { en: "USTV (YouTube)", zh: "非凡財經新聞（YouTube）" },
        title: { en: "Opening-day TV report: quantum and advanced packaging as this year's new draws",
                 zh: "半導體盛事 SEMICON Taiwan 登場！量子技術、先進封裝成新亮點" },
        summary: { en: "Taiwanese business television's opening-day piece, singling out the new Quantum Technology Zone and advanced packaging as what changed this year.",
                   zh: "台灣財經電視台的開展首日報導，點名新設的量子技術特區與先進封裝為今年的變化所在。" },
        href: "https://www.youtube.com/watch?v=NTqxGDMWtMs",
